// Symbol-level anatomy: top-level symbols (name, kind, line range, token
// estimate) so agents can slice-read big files instead of reading the whole
